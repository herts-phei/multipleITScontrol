#' @title level_difference
#'
#' @description Ascertains whether there is a statistically significant difference in a level during an intervention period between the pilot group and the control group. The estimated difference is relative to the control group. I.e. a positive coefficient means the slope. Returns
#'
...
level_difference <- function(model, intervention, return = TRUE) {
  ...
  ## Notes
  ## Calculates difference in coefficient for specific intervention, for level
